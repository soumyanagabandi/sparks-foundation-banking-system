...
<body>
  ...
  <div class="container">
      <div class="success mt-2 text-center" style="color:green;font-size:2.5rem;font-weight:bold">Transaction Successfull..!!! </div>
      <h2 class="text-center pt-4" style="color:blue;"> Transaction History </h2>
<form method="post" name="userselect"><br>
<div class="table-responsive-md">
    <table id=datatable class="table table-sm table-striped table-condensed table-bordered">
        <thead>
        <tr>
       ...
       <?php if(mysqli_num_rows($result)>0)
     {
       ...
       <tr>
       <td class="py-2 text-center"><?php echo $i?></td>
           <td class="py-2 text-center"><?php echo $row['sender']?></td>
           <td class="py-2 text-center"><?php echo $row['receiver']?></td>
